<%@ Page Title="" Language="VB" MasterPageFile="~/HandyHelpers.master" AutoEventWireup="false" CodeFile="CustomerLoginForm.aspx.vb" Inherits="CustomerLoginForm" %>
    ...
    <section class="login-frame">
        ...
        <section class="row">
            ...
            <section class="signup">
                <asp:HyperLink ID="hylregister" 
            runat="server" NavigateUrl="~/RegisterCustomerForm.aspx" CssClass = "signup">Don&#39;t have an account?</asp:HyperLink>
            </section>
